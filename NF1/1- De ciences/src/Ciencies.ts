...
function imc(pes:string, altura:string) : string {
   ...
   let pesNum : number = parseFloat(pes);
   let alturaNum : number 	= parseFloat(altura) / 100; 

   let alturaCuadrada : number = alturaNum * alturaNum;
   let imcValor : number = pesNum / alturaCuadrada;
